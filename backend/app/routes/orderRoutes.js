...
router.get("/seller-returns", verifyToken, allowRoles('admin', 'seller'), getSellerReturns);
router.put("/returns/:orderId/approve", verifyToken, allowRoles('admin', 'seller'), approveReturnRequest);
router.put("/returns/:orderId/reject", verifyToken, allowRoles('admin', 'seller'), rejectReturnRequest);
router.put("/returns/:orderId/assign-delivery", verifyToken, allowRoles('admin', 'seller'), assignReturnDelivery);
...
router.put("/skip/:orderId", verifyToken, allowRoles('admin', 'delivery'), skipOrder);
router.put("/return-status/:orderId", verifyToken, allowRoles('admin', 'delivery'), updateReturnStatus);
