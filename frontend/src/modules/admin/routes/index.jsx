...
const navItems = [
  ...
  },
  {
    ...
    color: "rose",
    children: [
      { label: "Hierarchy View", path: "/admin/categories/hierarchy" },
      { label: "Header Categories", path: "/admin/categories/header" },
      { label: "Level 2 Categories", path: "/admin/categories/level2" },
      { label: "Subcategories", path: "/admin/categories/sub" },
    ],
  },
