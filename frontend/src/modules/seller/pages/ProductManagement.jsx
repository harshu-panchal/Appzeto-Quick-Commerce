                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center space-x-2 mt-0.5">
                                            <Badge variant="primary" className="text-[7px] font-bold uppercase tracking-widest px-1 bg-blue-100 text-blue-700">SELLER</Badge>
            ...
            >
                <div className="p-4 flex flex-col items-center text-center space-y-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <p className="text-xs text-slate-500">This action cannot be undone. This will permanently remove <span className="font-bold text-slate-900">{itemToDelete?.name}</span> from the catalog.</p>
                    </div>
                </div>
            </Modal>
        </div>
