                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col leading-tight">
                            ...
                            <div className="flex items-center gap-1 font-black text-white text-base">
                                New York, USA <span className="text-[10px] opacity-70">▼</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="px-4 md:px-8 h-18 bg-white/95 backdrop-blur-sm rounded-full shadow-2xl flex items-center justify-between border border-white/20">
                    ...
                    <div className="flex items-center gap-6 mr-4 md:mr-12">
                        <Link to="/" className="flex items-center gap-1">
                            <span className="text-2xl md:text-3xl font-black text-[#0c831f] tracking-tight">Appzeto</span>
                        </Link>
                        ...
                        <div className="hidden md:flex items-center gap-2 pl-6 border-l border-slate-200">
                            <div className="flex flex-col items-start leading-none group cursor-pointer">
                                ...
                                <div className="flex items-center gap-1 font-bold text-slate-700 text-sm group-hover:text-[#0c831f] transition-colors">
                                    New York, USA <MapPin size={14} className="fill-current" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <nav className="hidden md:flex items-center gap-6">
                        <Link to="/" className="text-sm font-medium transition-colors hover:text-[#0c831f]">Home</Link>
                        <Link to="/products" className="text-sm font-medium transition-colors hover:text-[#0c831f]">Shop</Link>
                        <Link to="/categories" className="text-sm font-medium transition-colors hover:text-[#0c831f]">Categories</Link>
                    ...
                    <div className="hidden md:flex items-center gap-4">
                        <Link to="/wishlist" className="relative flex items-center justify-center p-2 hover:bg-slate-50 rounded-full transition-colors group">
                            <Heart className="h-6 w-6 text-slate-600 group-hover:text-[#0c831f] transition-colors" />
                            {wishlistCount > 0 && (
                        ...
                        <Link to="/cart" className="relative flex items-center justify-center p-2 hover:bg-slate-50 rounded-full transition-colors group">
                            <ShoppingCart className="h-6 w-6 text-slate-600 group-hover:text-[#0c831f] transition-colors" />
                            {cartCount > 0 && (
                                <span className="absolute top-0 right-0 h-5 w-5 rounded-full bg-[#0c831f] text-[10px] font-bold text-white flex items-center justify-center border-2 border-white shadow-sm animate-in zoom-in duration-300">
                                    {cartCount}
                                </span>
                        ...
                        <Link to="/profile" className="flex items-center justify-center">
                            <User className="h-6 w-6 text-slate-600 hover:text-[#0c831f] transition-colors" />
                        </Link>
                    </div>
                </div>
            </div>
