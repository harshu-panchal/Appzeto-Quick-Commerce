                    ...
                    >
                        ...
                        >
                            ...
                            <div className="p-8 space-y-6" id="printable-invoice">
                                <div className="flex justify-between items-start">
                                    <div>
                                        ...
                                        <p className="text-xs text-slate-500 mt-1">Quick Commerce Inc.<br />123, Tech Park, Bangalore</p>
                                    </div>
                            ...
                            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex gap-3">
                                <button onClick={handlePrint} className="flex-1 py-3 bg-[#0c831f] text-white rounded-xl font-bold flex items-center justify-center gap-2 hover:bg-[#0a701a] transition-colors shadow-lg shadow-green-200">
