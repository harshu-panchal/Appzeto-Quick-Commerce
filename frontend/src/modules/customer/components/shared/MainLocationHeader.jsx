                        ...
                        >
                            {categories.map((cat, idx) => {
                                ...
                                return (
                                    ...
                                    >
                                        <div className={`h-11 w-11 rounded-full flex items-center justify-center transition-all duration-300 ${isActive ? 'bg-[#1A1A1A] shadow-lg scale-105' : 'bg-white/10 hover:bg-white/20'}`}>
