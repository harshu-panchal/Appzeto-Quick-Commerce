                ...
                <div className="p-5 max-w-3xl mx-auto space-y-6">
                    <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100">
                        ...
                        <div className="prose prose-slate prose-sm max-w-none text-slate-600 space-y-4">
                            <p>
                                Welcome to Appzeto Quick Commerce. By accessing or using our mobile application and services, you agree to be bound by these Terms and Conditions.
                            </p>
                            ...
                            <p>
                                All content, trademarks, and data on this app are the property of Appzeto Quick Commerce and are protected by law.
                            </p>
